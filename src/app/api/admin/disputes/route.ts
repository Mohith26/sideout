...
/**
 * GET /api/admin/disputes[?tournamentId=] — every match whose consensus is
 * `disputed`, with both scorelines and the sets on which they differ
 * (spec §9). Organizer only.
 */
